...
## Страница «О сайте» (визитка разработчика)

Отдельная страница `/about` с рассказом о том, кто сделал сайт: фото, имя,
чем занимается, опыт цифрами, услуги, технологии и кнопки связи. Пункт
**«О сайте»** появляется в шапке, когда страница включена; пока выключена —
пункта нет, а адрес отвечает «страница не найдена».
