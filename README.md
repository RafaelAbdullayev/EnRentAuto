...
Размеры подстраиваются под экран: 44 px на телефоне, 56 px на широком экране;
в подвале и на странице входа — 64 и 80 px. Картинки нет или файл недоступен —
показывается фирменный знак «ER» с тем же названием, шапка не пустует.
