    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        <BrandImageUploader
          ...
          description="Фотография, GIF или видео на весь первый экран главной страницы. Видео идёт по кругу без звука — получается «живой фон». Поверх ложится тёмный градиент, чтобы заголовок и форма поиска оставались читаемыми. Нужен горизонтальный кадр от 1920×1080; главный объект лучше держать справа — слева его закроет текст."
